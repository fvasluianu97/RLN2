...
class InnerBlock(nn.Module):
    def __init__(self, num_channels, scale):
        ...
        self.ca_l = CCAttention(num_channels, out_channels, num_channels // 4)
        # self.ca_r = AgentAttention(num_channels, in_ch, wave_channels)
        self.ca_r = CCAttention(num_channels, out_channels, num_channels // 4)
...
class CC63(nn.Module):
    def __init__(self, num_feats=16, num_blocks=16):
        super(CC63, self).__init__()
        ...
        self.dwn2 = DownsampleLayer(64, 128)
        self.dwn3 = DownsampleLayer(128, 256)
        self.dwn4 = DownsampleLayer(256, 512)


        self.up1 = UpsampleLayer(512 + 1024, 256)
        self.up2 = UpsampleLayer(512 + 512, 128)
        self.up3 = UpsampleLayer(256 + 256, 64)
        self.up4 = UpsampleLayer(128, 28)


        inner_stage = []
        for i in range(num_blocks):
            inner_stage.append(InnerBlock(512, scale=4))
