...
class CC83(nn.Module):
    def __init__(self, num_feats=16, num_blocks=16):
        super(CC83, self).__init__()
        ...
        self.up1 = UpsampleLayer(512 + 384, 256)
        self.up2 = UpsampleLayer(512 + 192, 128)
        self.up3 = UpsampleLayer(256 + 96, 64)
